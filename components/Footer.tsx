      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-white mb-6">{settings.companyName}</h3>
            <p className="text-gray-400 max-w-sm mb-8">
              고객님의 건강과 건물의 가치를 최우선으로 생각합니다. 
              최첨단 장비와 풍부한 경험을 바탕으로 최상의 위생 솔루션을 제공합니다.
            </p>
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-[#8B5CF6] transition-colors">
