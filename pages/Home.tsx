    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          <h4 className="text-[#8B5CF6] font-semibold tracking-widest mb-6 animate-fadeInUp uppercase">Premium Cleaning Solution</h4>
          <h1 className="text-5xl md:text-7xl font-black mb-8 leading-tight tracking-tight animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fadeInUp" style={{ animationDelay: '0.6s' }}>
            <Link to="/contact" className="px-10 py-4 bg-[#8B5CF6] rounded-full font-bold hover:bg-[#7C3AED] purple-glow transition-all">
              무료 견적 상담
            </Link>
            <Link to="/portfolio" className="px-10 py-4 border border-white/20 rounded-full font-bold hover:bg-white hover:text-black transition-all">
              시공 사례 보기
            </Link>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex justify-between items-end mb-16">
            <div>
              ...
              <p className="text-gray-500">인정E&C만의 차별화된 위생 관리 기술을 경험하세요.</p>
            </div>
      ...
      <section className="py-24 bg-black">
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-4xl font-bold mb-6">최근 시공 사례</h2>
      ...
      <section className="py-24 bg-[#0A0A0A]">
        <div className="container mx-auto px-6">
          <div className="glass rounded-[40px] p-12 md:p-24 relative overflow-hidden text-center">
             ...
             <h2 className="text-3xl md:text-5xl font-black mb-8">당신의 공간을 더 가치 있게<br/>지금 전문가와 상의하세요</h2>
             <p className="text-gray-400 mb-12 max-w-xl mx-auto">대량 세척 할인 및 관공서/기업 전용 유지보수 계약 상담이 가능합니다.</p>
             <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <a href={`tel:${settings.phone}`} className="px-8 py-4 bg-white text-black font-bold rounded-full hover:bg-gray-200 transition-all">
                  전화 문의: {settings.phone}
                </a>
                <Link to="/contact" className="px-8 py-4 border border-[#8B5CF6] text-[#8B5CF6] font-bold rounded-full hover:bg-[#8B5CF6] hover:text-white transition-all">
                  온라인 상담 예약
                </Link>
             </div>
          </div>
